...
time -p sh -c 'yarn cache clean && yarn remove whisper.rn && yarn add https://github.com/JEF1056/whisper.rn.git && yarn build-dev --clear-cache && tailscale file cp ./dev.apk chromebook:'